...
#define AST_SYMBOL_ARR      43
#define AST_ATR_VETOR_INT   44
#define AST_ATR_VETOR_FLOAT 45
#define AST_SYMBOL_INT      46
#define AST_SYMBOL_FLOAT    47
#define AST_SYMBOL_CHAR     48
#define AST_REXPRP          49
